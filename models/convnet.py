...
class ConvNet(nn.Module):
    def __init__(self, n_classes):
        ...
        self.conv11 = ConvBNReLU(3, 64, 21, pad=1)
        self.conv12 = ConvBNReLU(64, 64, 17, pad=1)
        self.conv21 = ConvBNReLU(64, 128, 17, pad=1)
        self.conv22 = ConvBNReLU(128, 128, 9, pad=1)
        self.conv31 = ConvBNReLU(128, 256, 9, pad=1)
