...
class ConvNet(nn.Module):
    def __init__(self, n_classes):
        ...
        self.conv43 = ConvBNReLU(128, 256, 3, pad=1)
        self.conv44 = ConvBNReLU(256, 256, 3, pad=1)
        self.conv51 = ConvBNReLU(512, 512, 5, pad=1)
        self.conv52 = ConvBNReLU(512, 512, 3, pad=1)
        self.conv53 = ConvBNReLU(128, 256, 3, pad=1)
        self.conv54 = ConvBNReLU(256, 256, 3, pad=1)
